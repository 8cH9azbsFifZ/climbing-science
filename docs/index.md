...
2. **Reproducible** — Every formula traces back to a published reference (BibTeX in [`references.bib`](references.md)), not a black-box implementation.
...
All algorithms and formulas cite peer-reviewed sources. See [References](references.md) for the complete bibliography.
